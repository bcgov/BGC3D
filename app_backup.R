...
# setwd("C:\\Users\\CMAHONY\\OneDrive - Government of BC\\Projects\\2020_BGCProjections\\BGC3D")
...
# BGC labels
BGCs.BC <- read.csv("data/Clim.BGCs.BC.csv", stringsAsFactors = F)[,1]
BGCs.WNA <- read.csv("data/Clim.BGCs.WNA.csv", stringsAsFactors = F)[,1]
BGCs.sample.BC <- read.csv("data/Clim.sample.BC.csv", stringsAsFactors = F)[,1]
BGCs.sample.WNA <- read.csv("data/Clim.sample.WNA.csv", stringsAsFactors = F)[,1]
BGCs.future <- read.csv("data/Clim.BGCs.BC.future.csv", stringsAsFactors = F)[,1]

scenario <- read.csv("data/Clim.BGCs.BC.future.csv", stringsAsFactors = F)[,2:4]
rcps <- sort(unique(scenario[,2]))
proj.years <- unique(scenario[,3])

# Geographic Data
Geog.BGCs.BC <- read.csv("data/Clim.BGCs.BC.csv", stringsAsFactors = F)[,c(3,2,4)]
Geog.BGCs.WNA <- read.csv("data/Clim.BGCs.WNA.csv", stringsAsFactors = F)[,c(3,2,4)]
Geog.BGCs.BC.2004 <- read.csv("data/Clim.BGCs.BC.2004.csv", stringsAsFactors = F)[,c(3,2,4)]
Geog.sample.BC <- read.csv("data/Clim.sample.BC.csv", stringsAsFactors = F)[,c(3,2,4)]
Geog.sample.WNA <- read.csv("data/Clim.sample.WNA.csv", stringsAsFactors = F)[,c(3,2,4)]
Geog.BGCs.BC.future <- read.csv("data/Clim.BGCs.BC.future.csv", stringsAsFactors = F)[,c(6,5,7)]

# Climate Data
Clim.BGCs.BC <- read.csv("data/Clim.BGCs.BC.csv", stringsAsFactors = F)[,-c(1:4)]
Clim.BGCs.WNA <- read.csv("data/Clim.BGCs.WNA.csv", stringsAsFactors = F)[,-c(1:4)]
Clim.BGCs.BC.2004 <- read.csv("data/Clim.BGCs.BC.2004.csv", stringsAsFactors = F)[,-c(1:4)]
Clim.sample.BC <- read.csv("data/Clim.sample.BC.csv", stringsAsFactors = F)[,-c(1:4)]
Clim.sample.WNA <- read.csv("data/Clim.sample.WNA.csv", stringsAsFactors = F)[,-c(1:4)]
Clim.BGCs.BC.future <- read.csv("data/Clim.BGCs.BC.future.csv", stringsAsFactors = F)[,-c(1:7)]
...
ui <- fluidPage(
  navbarPage(title = paste("BGC projections in climate space"), theme = "bcgov.css", 
             tabPanel("3D", 
                      fluidRow(
                        column(2,
                               helpText("Biogeoclimatic units in climate space. Use mouse wheel to zoom, click/drag to spin"),
